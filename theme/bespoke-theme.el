...
(defvar bespoke-base-colors--defaults
  `((foreground . ,(face-foreground 'default nil t))
    ...
    (region . ,(face-background 'fringe nil t))
...
(defcustom bespoke-region (bespoke-base-colors--get 'region)
  ""
  :type 'color
  :group 'bespoke-themes)
...
(defun bespoke--set-theme-variant ()
  ...
  ;; (setq bespoke-region     (--l/d "#c8e1ff" "#0c2d6b"))
  (setq bespoke-region     (--l/d "#B8C5DB" "#0c2d6b"))
...
;;;;; Basic Faces
   ...
   `(region                                        ((,class :background ,bespoke-region)))
